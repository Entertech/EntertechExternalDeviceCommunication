...
| 指令       | 说明          |                                 |
|----------|-------------|---------------------------------|
| 0x01(01) | 下发开启脑电和心率指令 | 同startHeartAndBrainCollection方法 |
| 0x02(02) | 下发关闭脑电和心率指令 | 同stopHeartAndBrainCollection方法  |
| 0x03(03) | 下发进入固件升级指令  |                                 |
...
），佩戴状态（contactListeners[1字节]），脑波数据（bioAndAffectDataListeners[30字节]）
